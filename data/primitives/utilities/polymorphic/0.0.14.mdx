...
The [`OwnProps`](/docs/primitivesutilities/polymorphic#ownprops) should not contain DOM attributes. These will be added for you. Use the `Polymorphic.OwnProps` utility to extract these from existing polymorphic components.
